...
const parts = computed<Part[]>(() => [
  ...
  { src: couplePhoto.value, cls: "p-couple", l: 15.2, t: 24.6, w: 69.6 },
...
.hero.shown .p-joglo { animation: riseIn 1.4s cubic-bezier(0.16,1,0.3,1) 0.2s both; }
.hero.shown .p-frame { transform-origin: 50% 40%; animation: growIn 1.4s cubic-bezier(0.16,1,0.3,1) 0.32s both; }
.hero.shown .p-div { animation: fadeIn 1.2s ease 0.4s both; }
.hero.shown .t-l { transform-origin: 42% 13%; animation: swingL 1.4s cubic-bezier(0.16,1,0.3,1) 0.46s both; }
.hero.shown .t-r { transform-origin: 58% 13%; animation: swingR 1.4s cubic-bezier(0.16,1,0.3,1) 0.5s both; }
.hero.shown .p-couple { transform-origin: 50% 45%; animation: bloomIn 1.5s cubic-bezier(0.16,1,0.3,1) 0.4s both; }
.hero.shown .p-seal { transform-origin: 50% 50%; animation: bloomIn 1.4s cubic-bezier(0.16,1,0.3,1) 0.6s both; }

.hero.shown .f-tl { transform-origin: 0% 0%; animation: flTL 1.4s cubic-bezier(0.16,1,0.3,1) 0.68s both; }
.hero.shown .f-tr { transform-origin: 100% 0%; animation: flTR 1.4s cubic-bezier(0.16,1,0.3,1) 0.76s both; }
.hero.shown .f-bl { transform-origin: 0% 100%; animation: flBL 1.4s cubic-bezier(0.16,1,0.3,1) 0.86s both; }
