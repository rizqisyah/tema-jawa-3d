...
.sd.shown .sd-florL { transform-origin: 0 40%; animation: sdFlyL 1.7s cubic-bezier(0.34,1.56,0.64,1) 1.1s both, sdSwayA 8s ease-in-out 3.4s infinite alternate; }
.sd.shown .sd-florR { transform-origin: 100% 40%; animation: sdFlyR 1.7s cubic-bezier(0.34,1.56,0.64,1) 1.25s both, sdSwayB 8.6s ease-in-out 3.7s infinite alternate; }
...
@keyframes sdFlyL { 0% { opacity: 0; transform: translateX(-45%) rotate(-10deg) scale(1.04); } 100% { opacity: 1; transform: translateX(0) rotate(0) scale(1); } }
@keyframes sdFlyR { 0% { opacity: 0; transform: translateX(45%) rotate(10deg) scale(1.04); } 100% { opacity: 1; transform: translateX(0) rotate(0) scale(1); } }
